...
/**
 * This is the item provider adapter for a {@link net.sf.xqz.model.engine.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnginePackage.Literals.TRIGGER__KIND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnginePackage.Literals.TRIGGER__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		TriggerKind labelValue = ((Trigger)object).getKind();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Trigger.class)) {
			case EnginePackage.TRIGGER__KIND:
